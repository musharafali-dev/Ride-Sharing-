...
app.include_router(
    vehicles.router, prefix=f"{settings.API_V1_STR}/vehicles", tags=["Vehicles"]
)
app.include_router(
...
app.include_router(
    wallet.router, prefix=f"{settings.API_V1_STR}/wallet", tags=["Wallet"]
)
app.include_router(
...
def read_root():
    return {
        "message": "Welcome to RideSphere Multi-Vehicle Rental & Booking API Server!"
    }
